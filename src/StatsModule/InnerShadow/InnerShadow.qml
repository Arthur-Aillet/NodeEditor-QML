// Created with Qt Quick Effect Maker (version 0.44), Mon May 4 16:01:31 2026
...
Item {
    ...
    property real innerShadowBlurAmount: 0.7
    ...
    property real innerShadowHorizontalOffset: 0
    // HorizontalOffset and verticalOffset properties define the offset for the rendered shadow compared to the InnerShadow item position.
    property real innerShadowVerticalOffset: 0
    // This property defines the RGBA color value which is used for the shadow.
    property color innerShadowColor: Qt.rgba(0, 0, 0, 1)
    ...
    property real innerShadowSpread: 0.55
    ...
    property real blurMultiplier: 1.2029
    ...
    ShaderEffect {
        ...
        vertexShader: 'innershadow.vert.qsb'
        fragmentShader: 'innershadow.frag.qsb'
        anchors.fill: parent
    }
}
