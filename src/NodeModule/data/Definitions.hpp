...
enum class NodeRole {
  ...
  ComponentInitialProperties = 11, ///< QVariantMap
  ValidationState = 12,            ///< Enum NodeValidationState of the node
  LabelVisible = 13,               ///< `bool` for label visibility.
  ProcessingStatus = 14,           ///< Enum NodeProcessingStatus of the node
  ProgressValue = 15,              ///< 'QString' for the progress value
  Label = 16,                      ///< `QString` for node label.
  LabelEditable = 17,              ///< `bool` to indicate label editing support.
};
